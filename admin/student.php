	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			<ul class = "nav nav-pills">
				<li><a style="color:royalblue" href = "home.php"><span class = "glyphicon glyphicon-home"></span> Home</a></li>
				<li class = "dropdown active">
					<a class = "dropdown-toggle" style="background-color:royalblue;" data-toggle = "dropdown" href = "#"><span class = "glyphicon glyphicon-cog"></span> Records<span class = "caret"></span></a>
					<ul class = "dropdown-menu">
			...
			<br />
			<div style="background-color:royalblue; color:white" class = "alert alert-info">Records / Student</div>
			<div class = "modal fade" id = "add_student" tabindex = "-1" role = "dialog" aria-labelledby = "myModallabel">
				<div class = "modal-dialog" role = "document">
					<div class = "modal-content panel-primary">
						<div style="background-color:royalblue" class = "modal-header panel-heading">
						...
						<form method = "POST" action = "save_student_query.php" enctype = "multipart/form-data">
							...
							<div class = "modal-footer">
								<button  style="background-color:royalblue"  class = "btn btn-primary" name = "save"><span class = "glyphicon glyphicon-save"></span> Save</button>
							</div>
						</form>
					</div>
				</div>
			...
			<div class = "well col-lg-12">
				<button style="background-color:royalblue" class = "btn btn-success" type = "button" href = "#" data-toggle = "modal" data-target = "#add_student"><span class = "glyphicon glyphicon-plus"></span> Add Student</button>
				<br />
				<br />
				<table id = "table" class = "table table-bordered">
					<thead style="background-color:royalblue; color:white"class = "alert-info">
						<tr>
							<th>Student ID</th>
							<th>Firstname</th>
							<th>Middlename</th>
					...
					<tbody>
						...
						<tr>
							...
							<td><a class = "btn btn-danger rstudent_id" name = "<?php echo $f_student['student_id']?>" href = "#" data-toggle = "modal" data-target = "#delete"><span class = "glyphicon glyphicon-remove"></span></a> <a style="background-color:royalblue"class = "btn btn-warning  estudent_id" name = "<?php echo $f_student['student_id']?>" href = "#" data-toggle = "modal" data-target = "#edit_student"><span class = "glyphicon glyphicon-edit"></span></a></td>
						</tr>
						<?php
							}
						?>
